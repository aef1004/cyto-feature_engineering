...
fig_2 <- grid.arrange(p1, p2, p3, p5, p6, p7, p8, p9,
...
fig_2 <- grid.arrange(p1, p2, p3, p5, p6, p7, p8, p9,
             p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, 
             nrow = 5, left = textGrob("SSC-A", rot = 90, vjust = 1, gp=gpar(fontsize=14, lineheight=1)))
...
tiff("../figures/supp_2.tiff", width = 7, height = 10, units = 'in', res = 300)
