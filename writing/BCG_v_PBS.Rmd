...
superheat(corr, title = "Population Correlation", row.title = "Populations", column.title = "Populations",  bottom.label.col = c(rep("pink", 18), rep("light blue", 14), rep("orange", 8), rep("orchid3", 1)), left.label.col = c(rep("pink", 18), rep("light blue", 14), rep("orange", 8), rep("orchid3", 1)))
