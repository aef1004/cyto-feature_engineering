...
**THIS IS THE ONE**
Use mindensity for the sample alone - nothing else
Also using logicle
...
**Note I removed the redo of the logicle so that it uses the same logicle as above
...
```{r}
# this should be just the 36 populations that are present
...
library(Rtsne)
# remove duplicates
tsne <- Rtsne(all_gated_tSNE[,-1], dims = 2, perplexity=1, verbose=TRUE, max_iter = 500, check_duplicates = FALSE)
