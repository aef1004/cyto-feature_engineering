...
colors = rainbow(length(unique(all_gated_tSNE$lineage)))
names(colors) = unique(all_gated_tSNE$lineage)
...
ggplot(data_plot_FE, aes(x = tSNE_1, y = tSNE_2, col = all_gated_tSNE$lineage)) + 
  geom_point(size = 0.2) + 
  coord_fixed(ratio = 1) + 
